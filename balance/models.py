...
class Balance(models.Model):
    ...
    amount = models.DecimalField(max_digits=10, decimal_places=2, default=0, verbose_name='Баланс пользователя')
...
class Transaction(models.Model):
    ...
    type = models.CharField(max_length=10, choices=TransactionType.choices, verbose_name='Тип операции')
